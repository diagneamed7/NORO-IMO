    ...
    <>
      ...
      <div className={styles.topBar}>
        <div className={styles.container}>
          <a href="https://wa.me/221770000000" className={styles.contactItem}>
          ...
          <a href="tel:+221338000000" className={styles.contactItem}>
          ...
          <a href="mailto:contact@noroimmo.sn" className={styles.contactItem}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
